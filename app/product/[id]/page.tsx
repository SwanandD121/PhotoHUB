...
export default async function ServicePage({params}: {params: {id: string}}){
    ...
    return (
        <div>
            <section className="max-w-7xl mx-auto px-4 lg:px-8 lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16 mb-20">
                <Carousel className="lg:row-end-1 lg:col-span-4">
                    <CarouselContent>
                        {data?.images.map((item, index) => (
                            <CarouselItem key={index}>
                                <div className="aspect-w-4 aspect-h-3 rounded-lg bg-gray-100 overflow-hidden">
                                    <Image alt="service-image" src={item as string} fill className="object-cover w-full h-full rounded-lg"/>
                                </div>
                            </CarouselItem>
                        ))}
                    </CarouselContent>
                ...
                <div className="max-w-3xl mx-auto mt-5  lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3 w-96">
                ...
                <div className="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4">
                    {/* <ServiceDescription content={data?.description as JSONContent} /> */}
